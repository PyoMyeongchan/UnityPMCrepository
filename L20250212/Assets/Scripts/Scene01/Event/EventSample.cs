...
// Event Handler : 이벤트가 발생할 때 어떤 명령을 실행할 지 지정해주는 것

// 이벤트는 += 연산자를 통해 이벤트 핸들러를 이벤트에 추가할 수 있으며, -= 연사자를 통해 이벤트 핸들러를 삭제하는 것이 가능합니다.

// 하나의 이벤트에는 여러 개의 이벤트 핸들러를 추가하는 것이 가능하며, 추가한 핸들러들은 순차적으로 호출됩니다.
...
public class SpecialPortalEvent
{
    ...
    public void OnKill()
    {
        ...
        else
        {
            ...
            Debug.Log($"킬 이벤트 진행중입니다! [{count} / 5]");
