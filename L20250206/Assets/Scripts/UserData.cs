...
public class UserData
{
    ...
    //아이디, 이름, 비밀번호, 이메일, 번호 순서대로 작성하면 생성할 수 있는  UserData
    ...
    /// </summary>
    /// <returns>아이디,이름,비밀번호,이메일,번호</returns>
    ...
    /// </summary>
    /// <param name="data">아이디,이름,비밀번호,이메일,번호순으로 작성된 데이터</param>
    /// <returns></returns>
