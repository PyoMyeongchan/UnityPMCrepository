...
//IPointer Interface
//Unity의 EventSystem에서 기본적으로 제공되는 인터페이스입니다.
//사용하기 위해서는 다음과 같은 조건이 필요합니다.

// 클릭, 터치, 드래그 등의 이벤트를 구현할 때 사용합니다.

// 1. UI 오브젝트에는 Graphic Raycaster 컴포너트가 추가되어 있어야 합니다.
//    추가적으로 Raycaster Target이 체크가 된 상태여야 합니다.
// 2. Scene에는 Event System 컴포넌트가 존재햐야 합니다.
// 3. 오브젝트에 대한 작업 시에는 Collider 컴포넌트가 추가되어있어야 합니다.
// 4. Main Camera에 Physics Raycaster 컴포넌트가 추가되어있어야 합니다.
